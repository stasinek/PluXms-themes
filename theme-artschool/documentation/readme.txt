Ce gabarit adapté pour Pluxml fonctionne après avoir:
...
La page d'accueil utilise plusieurs fois la même liste d'articles, ceux qui font partie de la catégorie "page d'accueil".  Il est probablement plus pratique de changer certaines de ces listes pour des listes d'une catégorie spécifique comme par exemples "Nouvelles".
