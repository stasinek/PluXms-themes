		...
		<fieldset>
			<div class="grid">
				<div class="col sml-12">
					...
					<input id="id_name" class="ginput_left" name="name" type="text" size="30" value="<?php $plxShow->comGet('name',''); ?>" maxlength="30" />
				</div>
			</div>
			<div class="grid">
				<div class="col sml-12 lrg-6">
					<label for="id_mail"><?php $plxShow->lang('EMAIL') ?> :</label>
					<input id="id_mail" class="ginput_left"  name="mail" type="text" size="30" value="<?php $plxShow->comGet('mail',''); ?>" />
				</div>
				<div class="col sml-12 lrg-6">
					<label for="id_site"><?php $plxShow->lang('WEBSITE') ?> :</label>
					<input id="id_site" name="site"  class="ginput_left" type="text" size="30" value="<?php $plxShow->comGet('site',''); ?>" />
				</div>
			</div>
			<div class="grid">
				<div class="col sml-12">
					...
					<textarea   class="ginput_left" id="id_content" name="content" cols="35" rows="6"><?php $plxShow->comGet('content',''); ?></textarea>
				</div>
			</div>
			...
			<?php if($plxShow->plxMotor->aConf['capcha']): ?>
				<div class="grid">
					<div class="col sml-12">
						...
						<?php $plxShow->capchaQ(); ?>
						<input id="id_rep"  class="ginput_left" name="rep" type="text" size="2" maxlength="1" style="width: auto; display: inline;" />
					</div>
				</div>
			<?php endif; ?>
			<div class="grid">
				<div class="col sml-12">
					...
					<input  class="button gform_button"  type="submit" value="<?php $plxShow->lang('SEND') ?>" />
				</div>
			</div>
		</fieldset>
	</form>
