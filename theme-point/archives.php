...
<div id="page" class="home-page">
	<div class="content">
		<div class="article">
			<h1 class="postsby">
				<span><?php echo plxDate::formatDate($plxShow->plxMotor->cible, $plxShow->lang('ARCHIVES').' #month #num_year(4)') ?></span>
			</h1>	
				...
				<article class="pexcerpt post excerpt ">
					...
					<header>						
						...
						<div class="post-info">
							...
							<span class="thetime"><?php $plxShow->artDate('#num_day #month #num_year(4)'); ?></span></div>
					</header><!--.header-->
