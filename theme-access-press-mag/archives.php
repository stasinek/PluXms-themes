	...
	<div class="apmag-container">
		<div id="accesspres-mag-breadcrumbs" class="clearfix"><span class="bread-you">Vous êtes ici</span>
			<div class="ak-container">
				...
				<span class="current">
					<?php $plxShow->lang('ARCHIVES'); ?> : <?php echo plxDate::formatDate($plxShow->plxMotor->cible, $plxShow->lang('ARCHIVES').' #month #num_year(4)') ?>
				</span>
			</div>
		</div>
		<div id="primary" class="content-area">
			<header class="page-header">
				<h1 class="page-title"><span><?php $plxShow->lang('ARCHIVES'); ?> : <?php echo plxDate::formatDate($plxShow->plxMotor->cible, $plxShow->lang('ARCHIVES').' #month #num_year(4)') ?></span></h1>			
			</header><!-- .page-header -->
