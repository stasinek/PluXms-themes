...
<article id="post-24" class="post-24 page type-page status-publish hentry">
	<header class="page-header">
		<h1 class="page-title"><span><?php $plxShow->staticTitle(); ?></span></h1>	</header><!-- .entry-header -->

	<div class="entry-content">
		<div role="form" class="wpcf7" id="wpcf7-f85-p24-o1" lang="en-US" dir="ltr">
...
//						$lang_nosubject = "You did not enter a subject";
				...
				*/	
				...
				if ($error == "1") {
					...
					<form name="BELLonline_email" method="post" action="" class="wpcf7-form" >
