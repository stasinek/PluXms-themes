...
<div id="page">
<div id="header">
		<h1 style="padding-left:50px;font-size:1.8em;"><?php $plxShow->mainTitle('link'); ?></h1>
		<div id="subtitle" style="padding-left:50px;font-size:1.5em;"><?php $plxShow->subTitle(); ?></div>
	</div>
	<div id="wrap">
