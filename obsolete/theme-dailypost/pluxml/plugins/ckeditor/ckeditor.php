...
class ckeditor extends plxPlugin {
	...
	public function __construct($default_lang) {
		...
		# pas d'éditeur ckeditor pour les pages parametres_edittpl.php, statique.php et comment.php
	...
	if(typeof CKEDITOR != 'undefined') {
		...
		for(var i=0;i<textareas.length;i++) {
			CKEDITOR.replace('id_'+textareas[i].name, {
				...
				toolbar :
				[
					['Source','Preview','-','Undo','Redo','Cut','Copy','Paste','PasteText','PasteFromWord','-','Find','Replace','-','SelectAll','RemoveFormat'],
					['-','Table','HorizontalRule','Smiley','SpecialChar'],
					'/',
					['JustifyLeft','JustifyCenter','JustifyRight','JustifyBlock'],
					['Bold','Italic','Underline','Strike','-','Link','Image','Flash','Unlink','Anchor','-','NumberedList','BulletedList','-','Outdent','Indent','-','Subscript','Superscript','Blockquote','CreateDiv'],
					'/',
