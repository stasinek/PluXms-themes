...
<div id="page">
	<div id="content">
		<div class="post">
			<h2 class="title"><?php $plxShow->artTitle(); ?></h2><p class="post-info">le <?php $plxShow->artDate(); ?> &agrave; <?php $plxShow->artHour(); ?></p>
			<?php $plxShow->artContent(); ?>
			<p class="author">Par <?php $plxShow->artAuthor(); ?></p>
